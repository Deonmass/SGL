  ...
  return (
    ...
    >
      <div className="p-6 md:p-8">
        <div className="w-14 h-14 bg-primary-100 rounded-full flex items-center justify-center text-primary-600 mb-5 group-hover:bg-primary-600 group-hover:text-white transition-all duration-300">
          {icon}
        </div>
...
const ServicesSection: React.FC = () => {
  ...
  return (
    <section className="section bg-gray-50 min-h-screen scroll-snap-align-start flex items-center" id="services">
      <div className="container-custom py-8">
        ...
        >
          ...
          <p className="section-subtitle mx-auto">{t('home.services.subtitle')}</p>
        </motion.div>
